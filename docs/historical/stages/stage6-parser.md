...
Stage 6B provides this explicit confirmation and atomic Manual Food/trace creation; see
`docs/historical/stages/stage6-confirmation.md`. Physical-device Stage 5 camera and overlay QA
remains outstanding, and parsing still does not rely on geometry.
