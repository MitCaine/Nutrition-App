...
in the [Architecture Overview](../architecture/overview.md). A fresh database does not need legacy Recipe
...
| --- | --- | --- |
| Phase 1 | Explicit deployment modes, caller identity, fail-closed production auth | [Phase 1](../historical/production-hardening/production-hardening-phase1.md) |
| Phase 5A | Stop destructive upgrade of populated legacy Recipe tables | [Phase 5A](../historical/production-hardening/production-hardening-phase5a.md) |
| Phase 5B | Read-only, privacy-safe historical database inventory | [Phase 5B](../historical/production-hardening/production-hardening-phase5b.md) |
| Phase 5C1 | Isolated clone bridge, archive, deterministic conversion plan | [Phase 5C1](../historical/production-hardening/production-hardening-phase5c1.md) |
| Phase 5C2 | Authorized checkpointed conversion with restart-safe outcomes | [Phase 5C2](../historical/production-hardening/production-hardening-phase5c2.md) |
| Phase 5C3a | Independent PostgreSQL-only correctness qualification | [Phase 5C3a](../historical/production-hardening/production-hardening-phase5c3a.md) |
| Phase 5C3b / 5C2.2 | Deterministic performance fixtures, evidence, and bounded optimization | [Phase 5C3b](../historical/production-hardening/production-hardening-phase5c3b.md), [Phase 5C2.2](../historical/production-hardening/production-hardening-phase5c2.2.md) |
| Phase 5C4.0 | Freeze the controlled portfolio deployment profile and trust decisions | [Phase 5C4.0](../historical/production-hardening/production-hardening-phase5c4.0.md) |
| Stage 5C4.1 | Versioned canonical promotion contracts and tamper validation | Contract modules and tests |
| Stage 5C4.2 | Least-privilege application roles, local target identity/write fence, canary prerequisites | [Phase 5C4.2a](../historical/production-hardening/production-hardening-phase5c4.2a.md), migration 0018 |
...
| Resource membership 0019 | Database-enforced ownership/membership, read-only corruption inventory, and distinct current-schema admission | [Resource membership](runbooks/resource-membership.md), application migration 0019, ops migration 0005 |
| Immutable provenance 0020 | Database-enforced historical immutability and exact current-schema admission | [Immutable provenance](runbooks/immutable-provenance.md), application migration 0020, ops migration 0006 |
| Stage 5C4.5 | Idempotent local restore execution, atomic restored-database qualification, and immutable recovery evidence | [Phase 5C4.5](../historical/production-hardening/production-hardening-phase5c4.5.md), ops migration 0007 |
| Stage 5C4.6 | Purpose-specific Ed25519 target-activation authorization admission; no consumption or activation | [Phase 5C4.6](../historical/production-hardening/production-hardening-phase5c4.6.md), ops migration 0008 |
| Stage 5C4.7a | Purpose-specific promotion admission, one-use route intent, closed-target route/post-cutover evidence, and activation-evidence binding; no activation or opening | [Phase 5C4.7a](../historical/production-hardening/production-hardening-phase5c4.7a.md), ops migration 0009 |
| Stage 5C4.7b | Separate schema-0021 execution authority, forward-only target migration, one-use activation, runtime observation/reconciliation, and emergency close | [Phase 5C4.7b](runbooks/target-activation.md), application migration 0021, ops migration 0010 |
| Stage 5C4.8 (bounded recovery qualification) | Purpose-specific executable preactivation cutback, crash/reconciliation correction, cumulative recovery qualification, and read-only postactivation PITR qualification | [Phase 5C4.8](runbooks/recovery-and-cutback.md); ops 0011 installs the cutback authority lifecycle, v9, and the audit snapshot |
| Stage 5C4.9 (Version 1.0 release gate) | PostgreSQL fixture cleanup, frozen 0001 nutrient seed, synchronized operator contracts, and clean-commit qualification evidence | [Phase 5C4.9](../historical/releases/production-hardening-phase5c4.9.md); application and control heads remain unchanged |

The broad [Phase 5C4 design record](../historical/production-hardening/production-hardening-phase5c4.md) describes later promotion,
...
rules are in [Database-Enforced Resource Membership](runbooks/resource-membership.md).
...
[Immutable Historical Provenance](runbooks/immutable-provenance.md).
...
- [Project Invariants](../project/invariants.md#why-a-control-plane) for architectural rationale
- [Architecture Overview](../architecture/overview.md#runtime-and-canary-modes) for the current application boundary
- [Development Guide](../project/development-guide.md#if-you-need-to-modify-the-control-plane) for code entry points
