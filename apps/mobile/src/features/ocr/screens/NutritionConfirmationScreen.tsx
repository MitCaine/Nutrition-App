...
export function NutritionConfirmationScreen({ initialDraft, onCancel, onCreated }: {
  ...
  return <View style={styles.screen}>
    <KeyboardSafeScrollView contentContainerStyle={styles.content}>{() => <>
      <View style={styles.header}><Text accessibilityRole="header" style={styles.title}>Confirm nutrition</Text><Pressable accessibilityLabel="Cancel confirmation" accessibilityRole="button" accessibilityState={{ disabled: submitting }} disabled={submitting} onPress={cancel}><Text style={styles.link}>Cancel</Text></Pressable></View>
      ...
      <TextInput editable={!submitting} accessibilityLabel="Food name" accessibilityState={{ disabled: submitting }} value={draft.name} onChangeText={(name) => setDraft({ ...draft, name })} placeholder="Food name (required)" placeholderTextColor={theme.colors.placeholder} style={styles.input}/>
      <TextInput editable={!submitting} accessibilityLabel="Brand" accessibilityState={{ disabled: submitting }} value={draft.brand} onChangeText={(brand) => setDraft({ ...draft, brand })} placeholder="Brand" placeholderTextColor={theme.colors.placeholder} style={styles.input}/>
      <TextInput editable={!submitting} accessibilityLabel="Notes" accessibilityState={{ disabled: submitting }} value={draft.notes} onChangeText={(notes) => setDraft({ ...draft, notes })} placeholder="Notes" placeholderTextColor={theme.colors.placeholder} style={styles.input}/>
      <Text accessibilityRole="header" style={styles.section}>Serving</Text>
      <TextInput editable={!submitting} accessibilityLabel="Serving label" accessibilityState={{ disabled: submitting }} value={draft.servingDisplay} onChangeText={(servingDisplay) => setDraft({ ...draft, servingDisplay })} placeholder="Serving label" placeholderTextColor={theme.colors.placeholder} style={styles.input}/>
