...
test("target progress remains independent but cannot claim zero while entries are unknown", () => {
  ...
  const knownComparison = { ...comparison, comparisons: [{ nutrientId: "calories", consumedAmount: "0", targetAmount: "2000", unit: "kcal" as const, percentage: "0", authority: "calculated_estimate" as const, direction: "target" as const, status: "available" as const, reasonCode: null, noteCode: null, hasUnknownContributors: false }] };
