...
test("daily comparison maps direction, notes, unknown state, and date-scoped request", async () => {
  ...
  global.fetch = jest.fn().mockResolvedValue({ ok: true, status: 200, json: async () => ({
    ...
    dri_dataset_version: "nasem_dri_adults_2026_v1",
    target_direction_semantics_version: "target_directions_2026_v1",
    comparisons: [{ nutrient_id: "sodium", consumed_amount: "2600", target_amount: "2300", unit: "mg", percentage: "113.0435", authority: "daily_value", direction: "limit", status: "available", reason_code: null, note_code: null, has_unknown_contributors: true, reference_type: null, source_version: null, source_id: null, calculation_basis: null }],
  }) }) as typeof fetch;
...
test("malformed comparison direction fails safely", async () => {
  ...
  global.fetch = jest.fn().mockResolvedValue({ ok: true, status: 200, json: async () => ({
    ...
    comparisons: [{ nutrient_id: "sodium", consumed_amount: "1", target_amount: "2", unit: "mg", percentage: "50", authority: "daily_value", direction: "good", status: "available", reason_code: null, note_code: null, has_unknown_contributors: false, reference_type: null, source_version: null, source_id: null, calculation_basis: null }],
  }) }) as typeof fetch;
